...
Процедура ЗаполнитьНаборТестов(НаборТестов) Экспорт
	...
	НаборТестов.Добавить("ПросмотрРезультатЗапросаБезМенеджераВременныхТаблиц");
	НаборТестов.Добавить("ПросмотрРезультатЗапросаСПустымМенеджеромВременныхТаблиц");
	НаборТестов.Добавить("ПросмотрРезультатЗапросаСНеПустымМенеджеромВременныхТаблиц");
	НаборТестов.Добавить("ПросмотрРезультатЗапросаССозданиемТаблицы");
	НаборТестов.Добавить("ПросмотрРезультатЗапросаСУничтожениемТаблицы");
...
Функция ПросмотрРезультатЗапросаБезМенеджераВременныхТаблиц() Экспорт
...
Функция ПросмотрРезультатЗапросаСПустымМенеджеромВременныхТаблиц() Экспорт
...
Функция ПросмотрРезультатЗапросаСНеПустымМенеджеромВременныхТаблиц() Экспорт
...
Функция ПросмотрРезультатЗапросаССозданиемТаблицы() Экспорт
...
Функция ПросмотрРезультатЗапросаСУничтожениемТаблицы() Экспорт
